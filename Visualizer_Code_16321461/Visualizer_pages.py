...
def animate(i):
    a.clear() # clears the subplots of the previous update
    sensor = live_sensor # copies the global variable
    s = "generated_data\\sensor_id_" + str(sensor) + ".csv"
    df = pd.read_csv(s) # create dataframe
...
class MainPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        # # LAYOUT # #
        photo = tk.PhotoImage(file="Images\\Trinity_Logo.png") # image file
        ...
        canvas.grid(row=0, column = 0, padx = 10, pady = 10, sticky = tk.NW)

        title_label = tk.Label(self, text = "Visualizer of energy-aware schedueler", font = 'Times 35 ')
        title_label.grid(row = 0, column = 1, columnspan = 6, padx = 10, pady = 10)

        info_box = tk.Text(self, width = 60, height = 7, background = 'white')
        info_box.grid(row = 1, column = 0, columnspan = 2, padx = 10, pady = 10, sticky = tk.W)
        ...
        map_photo = tk.PhotoImage(file="Images\\diagram.png")
        ...
        map_label.grid(row = 2, column = 0, columnspan = 2, padx = 5, pady = 5, sticky = tk.NW)

        tk.Label(self, text = 'Image of Sensor Map', font = 'Helvetica 12 bold italic').grid(row = 5, column = 0, columnspan = 1, padx = 5, sticky = tk.NW)
        ...
        graph_wall.grid(row = 1, column = 3, columnspan = 6, padx = 5, pady = 5, rowspan = 5, sticky = tk.N)
